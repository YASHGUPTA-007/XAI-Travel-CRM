...
const Header = () => {
  ...
  const navItems = [
    { name: t('nav.features'), href: '#features' },
    {
      ...
      href: '#solutions',
      dropdown: [
        { name: t('solutions.travelAgencies'), href: '#agencies' },
        { name: t('solutions.soloAgents'), href: '#solo' },
        { name: t('solutions.groupOrganizers'), href: '#groups' },
        { name: t('solutions.corporateTeams'), href: '#corporate' }
      ]
    },
